...
public class OrderActivity extends AppCompatActivity {
    ...
    String strTitle;
    int paket1 = 10000, paket2 = 25000, paket3 = 20000, paket4 = 23000, paket5 = 20000, paket6 = 70000;
    ...
    private void setInputData() {
        btnCheckout.setOnClickListener(v -> {
            if (totalItems == 0 || totalPrice == 0) {
                Toast.makeText(OrderActivity.this, "Pilih menu makanan dulu!",
                        Toast.LENGTH_SHORT).show();
            } else if (totalItems < 5) {
                Toast.makeText(OrderActivity.this, "Minimal 5 pesanan!",
                        Toast.LENGTH_SHORT).show();
            } else {
